...
class ShowPoint extends JPanel{
	 ...
	 * @param color - 点的显示颜色
	 */
	ShowPoint(NodePool nodePool, float width, Color color){
	 ...
	 * @param color - 点的显示颜色
	 */
	ShowPoint(Node node, float width, Color color){
		pointSet = new HashSet<>();
	 ...
	 * @param color - 点的显示颜色
	 */
	ShowPoint(Set<Node> nodeSet, float width, Color color){
		pointSet = new HashSet<>();
		for(Node node : nodeSet){
			pointSet.add(new DisplayPoint(node, width, color));
		}
	 ...
	 * @param color - 点的显示颜色
	 */
	ShowPoint(float width, Color color, Set<Point> pointSet){
		pointSet = new HashSet<>();
